  ...
  return (
    <Layouts>
      ...
      <Dokter
        ...
        description="Bergabunglah dengan konsultasi ahli yang saling mendukung dan terhubung dengan para ahli kesehatan untuk mendapatkan saran yang tepat. Dapatkan pengalaman berbagi, motivasi, dan bantuan langsung dalam perjalanan menuju hidup sehat, bersama individu-individu yang memiliki tujuan yang sama."
      />
